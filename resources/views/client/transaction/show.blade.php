                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="text-end">
                                ...
                                <p>Issued: <span class="digits"> {{ Carbon\Carbon::parse($order->date_order)->format('d/M/Y') }} </span><br>
                                </p>
                            </div><!--End Title-->
                        </div>
                    </div>
                    ...
                    <div>
                        <div id="table" class="table-responsive invoice-table">
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <td class="item"><h6 class="p-2 mb-0">Participant</h6></td>
                                        <td class="item"><h6 class="p-2 mb-0">Course Name</h6></td>
                                        <td class="Hours"><h6 class="p-2 mb-0">Quantity</h6></td>
                                        <td class="Rate"><h6 class="p-2 mb-0">Price</h6></td>
                                        <td class="Rate"><h6 class="p-2 mb-0">Sub-Total</h6></td>
                                    </tr>
                                </thead>
                                <tbody>
                                    @php
                                    ...
                                    @foreach ($order->unique_child as $child)
                                        ...
                                        @foreach ($order->unique_courses as $course)
                                            <tr>
                                                @if ($firstCourse)
                                                    <td rowspan="{{ count($order->unique_courses) }}">{{ $child->name }}</td>
                                                    @php
                                                        $firstCourse = false;
                                                    @endphp
                                                @endif
                                                <td>{{ $course->name }}</td>
                                                <td>{{ 1 }}</td> <!-- Assuming quantity is 1 for each course per child -->
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="3"></td>
                                        <td class="Rate"><h6 class="mb-0 p-2">Total</h6></td>
                                        <td class="payment digits"><h6 class="mb-0 p-2">@currency($total)</h6></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div><!--End Table-->

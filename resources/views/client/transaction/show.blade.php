                ...
                <div class="card mb-5">
                    <div class="card-header d-flex justify-content-between">
                        @if ($order->status == 'draft')
                            <a href="{{ route('client.transaction.cancel', $order->id) }}" class="btn btn-danger"><i
                                    class="fas fa-times"></i> Cancel Transaction</a>
                        @endif
                        <a href="{{ route('client.transaction') }}" class="btn btn-primary"><i
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div>
                                        <p class="legal">Silahkan transfer ke rekening <strong>Mandiri: 1090020804423. AN
                                                Bimbel BUC TEVA.</strong>
                                        </p>
                                    </div>
